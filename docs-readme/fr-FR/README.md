...
Pour l'ensemble des matériaux du cours, veuillez visiter le **[Site de Documentation](https://amitabhakarmakar.github.io/harness-engineering)**.
...
Récupérez les modèles de démarrage depuis la [Bibliothèque de Ressources](https://amitabhakarmakar.github.io/harness-engineering/en/resources) et déposez-les dans votre projet. C'est tout. Quatre fichiers, et vos sessions d'agent seront déjà nettement plus stables qu'avec des prompts seuls.
...
*Lisez le texte complet de chaque cours sur le [Site de Documentation](https://amitabhakarmakar.github.io/harness-engineering).*

| Session | Question | Idée Centrale |
|---------|----------|---------------|
| [L01](../../docs/en/lectures/lecture-01-why-capable-agents-still-fail/) | Pourquoi les modèles performants échouent-ils encore sur des tâches réelles ? | L'écart de capacité entre les benchmarks et l'ingénierie réelle |
| [L02](../../docs/en/lectures/lecture-02-what-a-harness-actually-is/) | Que signifie réellement « harness » ? | Cinq sous-systèmes : instructions, état, vérification, portée, cycle de vie |
| [L03](../../docs/en/lectures/lecture-03-why-the-repository-must-become-the-system-of-record/) | Pourquoi le dépôt doit-il être l'unique source de vérité ? | Si l'agent ne peut pas le voir, ça n'existe pas |
| [L04](../../docs/en/lectures/lecture-04-why-one-giant-instruction-file-fails/) | Pourquoi un seul fichier d'instructions géant échoue-t-il ? | Divulgation progressive : donnez une carte, pas une encyclopédie |
| [L05](../../docs/en/lectures/lecture-05-why-long-running-tasks-lose-continuity/) | Pourquoi les tâches de longue durée perdent-elles leur continuité ? | Persister le progrès sur disque ; reprendre là où vous vous êtes arrêté |
| [L06](../../docs/en/lectures/lecture-06-why-initialization-needs-its-own-phase/) | Pourquoi l'initialisation nécessite-t-elle sa propre phase ? | Vérifier que l'environnement est sain avant que l'agent ne commence à travailler |
| [L07](../../docs/en/lectures/lecture-07-why-agents-overreach-and-under-finish/) | Pourquoi les agents vont-ils trop loin et n'en font-ils pas assez ? | Une seule fonctionnalité à la fois ; définition explicite de « terminé » |
| [L08](../../docs/en/lectures/lecture-08-why-feature-lists-are-harness-primitives/) | Pourquoi les listes de fonctionnalités sont-elles des primitives du harness ? | Des limites de portée lisibles par machine que l'agent ne peut pas ignorer |
| [L09](../../docs/en/lectures/lecture-09-why-agents-declare-victory-too-early/) | Pourquoi les agents déclarent-ils victoire trop tôt ? | Lacunes de vérification : confiance ≠ correction |
| [L10](../../docs/en/lectures/lecture-10-why-end-to-end-testing-changes-results/) | Pourquoi les tests de bout en bout changent-ils les résultats ? | Seule une exécution complète du pipeline compte comme véritable vérification |
| [L11](../../docs/en/lectures/lecture-11-why-observability-belongs-inside-the-harness/) | Pourquoi l'observabilité appartient-elle au harness ? | Si vous ne pouvez pas voir ce que l'agent a fait, vous ne pouvez pas corriger ce qu'il a cassé |
| [L12](../../docs/en/lectures/lecture-12-why-every-session-must-leave-a-clean-state/) | Pourquoi chaque session doit-elle laisser un état propre ? | Le succès de la prochaine session dépend du nettoyage de celle-ci |
...
|--------|--------------------|----------------------|
| [P01](../../docs/en/projects/project-01-baseline-vs-minimal-harness/) | Exécuter la même tâche deux fois : avec prompts seuls vs. avec règles d'abord | Harness minimal : AGENTS.md + init.sh + feature_list.json |
| [P02](../../docs/en/projects/project-02-agent-readable-workspace/) | Restructurer le dépôt pour que l'agent puisse le lire | Espace de travail lisible par l'agent + fichiers d'état persistants |
| [P03](../../docs/en/projects/project-03-multi-session-continuity/) | Faire en sorte que l'agent reprenne là où il s'est arrêté | Journal de progression + transfert de session + continuité multi-sessions |
| [P04](../../docs/en/projects/project-04-incremental-indexing/) | Empêcher l'agent d'en faire trop ou pas assez | Retour d'exécution + contrôle de portée + indexation incrémentale |
| [P05](../../docs/en/projects/project-05-grounded-qa-verification/) | Faire en sorte que l'agent vérifie son propre travail | Auto-vérification + Q&A fondé + achèvement basé sur les preuves |
| [P06](../../docs/en/projects/project-06-runtime-observability-and-debugging/) | Construire un harness complet à partir de zéro (projet final) | Harness complet : tous les mécanismes + observabilité + étude d'ablation |
...
Consultez la liste complète de références en couches dans [`docs/en/resources/reference/`](../../docs/en/resources/reference/).
