...
Le pack de démarrage dans [`repo-template/`](./repo-template/) reflète
...
2. Copiez les fichiers dans [`repo-template/`](./repo-template/) dans
...
Le dossier [`sops/`](./sops/) transforme les diagrammes de l'article en
