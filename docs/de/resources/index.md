...
- [`templates/`](./templates/): Vorlagen zum Kopieren in ein echtes Repository
- [`reference/`](./reference/): Methodennotizen, Startablauf und Karten von Fehlermodi
- [`openai-advanced/`](./openai-advanced/): erweitertes Repository-Gerüst, system-of-record-Dokumente und agent-first Governance-Vorlagen
...
Wenn das Repository zu einem länger laufenden System mit mehreren Domänen, aktiven Plänen, Qualitätsscores und Zuverlässigkeitsrichtlinien wächst, wechsle zum Paket [`openai-advanced/`](./openai-advanced/), statt das Minimalpaket zu weit zu dehnen.
