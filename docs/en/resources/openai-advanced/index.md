...
The starter pack under [`repo-template/`](./repo-template/) mirrors the
structure below:
...
2. Copy the files in [`repo-template/`](./repo-template/) into your
...
The [`sops/`](./sops/) folder turns the article's diagrams into
