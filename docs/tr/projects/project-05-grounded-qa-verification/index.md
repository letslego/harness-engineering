...
> İlgili dersler: [Ders 09. Ajanların zaferi erken ilan etmesini durdurun](./../../lectures/lecture-09-why-agents-declare-victory-too-early/) · [Ders 10. Yalnızca tam hat çalıştırması gerçek doğrulama sayılır](./../../lectures/lecture-10-why-end-to-end-testing-changes-results/)
...
Depo yolu: [`projects/project-05/`](https://github.com/amitabhakarmakar/harness-engineering/tree/main/projects/project-05)

| Dizin | İçerik | Nasıl kullanılır |
|------|------|------|
| [`starter/`](https://github.com/amitabhakarmakar/harness-engineering/tree/main/projects/project-05/starter) | ConversationHistory yükseltmesinden önceki Project 04 uygulaması. | Üç varyantı kendiniz yeniden çalıştırmak istiyorsanız buradan başlayın. |
