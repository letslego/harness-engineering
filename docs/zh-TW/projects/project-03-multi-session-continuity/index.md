...
> 相關講義：[L05. 讓跨工作階段的任務保持脈絡連續](./../../lectures/lecture-05-why-long-running-tasks-lose-continuity/) · [L06. 讓 agent 每次工作前先初始化](./../../lectures/lecture-06-why-initialization-needs-its-own-phase/)
...
倉庫路徑：[`projects/project-03/`](https://github.com/letslego/harness-engineering/tree/main/projects/project-03)
...
- [Lecture 07 — 為什麼 agent 總是做過頭、做不完](../../lectures/lecture-07-why-agents-overreach-and-under-finish/)
- [Lecture 08 — 為什麼 feature list 是 harness 的基礎原語](../../lectures/lecture-08-why-feature-lists-are-harness-primitives/)
