...
Das Starter-Pack unter [`repo-template/`](./repo-template/) spiegelt die
...
2. Kopieren Sie die Dateien aus [`repo-template/`](./repo-template/) in
...
Der Ordner [`sops/`](./sops/) wandelt die Diagramme des Artikels in
