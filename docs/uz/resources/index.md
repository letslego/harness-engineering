...
- [`templates/`](./templates/): haqiqiy repoga koʻchirish uchun andozalar
- [`reference/`](./reference/): metod eslatmalari, ishga tushirish oqimi (startup flow) va xatolik rejimlarining (failure-mode) xaritalari
- [`openai-advanced/`](./openai-advanced/): ilgʻor repo skeleti, yagona haqiqat manbai (system-of-record) hujjatlari va agent-first boshqaruv (governance) andozalari
...
Agar repo bir nechta domenlar, faol rejalar, sifat baholash (quality scoring) va ishonchlilik siyosatlarini (reliability policies) oʻz ichiga olgan, uzoq vaqt ishlaydigan tizimga aylansa, minimal toʻplamni haddan tashqari choʻzish oʻrniga [`openai-advanced/`](./openai-advanced/) toʻplamiga oʻting.
