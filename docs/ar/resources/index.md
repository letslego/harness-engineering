...
- [`templates/`](./templates/): قوالب لنسخها إلى مستودع حقيقي
- [`reference/`](./reference/): ملاحظات منهجية، تدفق بدء التشغيل، وخرائط أنماط الفشل
- [`openai-advanced/`](./openai-advanced/): هيكل مستودع متقدم، وثائق system-of-record، وقوالب حوكمة agent-first
...
عندما ينمو المستودع إلى نظام طويل الأمد بعدة نطاقات، وخطط نشطة، وتقييم جودة، وسياسات موثوقية، انتقل إلى حزمة [`openai-advanced/`](./openai-advanced/) بدلًا من مد الحزمة البسيطة أكثر من اللازم.
