...
[`repo-template/`](./repo-template/) 아래에 있는 스타터 팩은 아래와 같은 구조를 반영합니다.
...
2. 더 강한 구조가 필요해지면 [`repo-template/`](./repo-template/)의 파일들을 자신의 저장소에 복사하십시오.
...
[`sops/`](./sops/) 폴더는 원문 문서의 다이어그램을 단계별 운영 절차(표준 작업 절차, SOP)로 변환한 것입니다.
