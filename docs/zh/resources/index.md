...
- [`templates/`](./templates/)：可以直接复制到真实仓库里的模板
- [`reference/`](./reference/)：方法说明、启动流程和问题对照表
- [`openai-advanced/`](./openai-advanced/)：更完整的 OpenAI 风格高级资源包，包括仓库骨架、质量文档、执行计划和系统级治理文件
...
[`openai-advanced/`](./openai-advanced/) 这一套高级结构，而不是继续把最小模板硬撑成一个大而乱的系统。
