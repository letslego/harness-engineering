...
O pacote inicial em [`repo-template/`](./repo-template/) espelha a estrutura abaixo:
...
2. Copie os arquivos em [`repo-template/`](./repo-template/) para o seu próprio repositório assim que precisar de uma estrutura mais forte.
...
A pasta [`sops/`](./sops/) transforma os diagramas do artigo em procedimentos operacionais passo a passo:
