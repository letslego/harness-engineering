...
Стартовый пак в [`repo-template/`](./repo-template/) повторяет
структуру ниже:
...
2. Скопируйте файлы из [`repo-template/`](./repo-template/) в ваш
...
Папка [`sops/`](./sops/) превращает диаграммы из статьи в пошаговые
