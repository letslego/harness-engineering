...
Depo yolu: [`projects/project-05/`](https://github.com/letslego/harness-engineering/tree/main/projects/project-05)

| Dizin | İçerik | Nasıl kullanılır |
|------|------|------|
| [`starter/`](https://github.com/letslego/harness-engineering/tree/main/projects/project-05/starter) | ConversationHistory yükseltmesinden önceki Project 04 uygulaması. | Üç varyantı kendiniz yeniden çalıştırmak istiyorsanız buradan başlayın. |
