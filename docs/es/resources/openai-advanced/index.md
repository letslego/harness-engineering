...
El pack de inicio en [`repo-template/`](./repo-template/) refleja la
...
2. Copia los archivos en [`repo-template/`](./repo-template/) a tu
...
La carpeta [`sops/`](./sops/) convierte los diagramas del artículo en
