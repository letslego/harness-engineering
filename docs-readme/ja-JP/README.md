...
完全なコース資料については、**[ドキュメントウェブサイト](https://letslego.github.io/harness-engineering)** をご覧ください。
...
[リソースライブラリ](https://letslego.github.io/harness-engineering/en/resources)からスターターテンプレートを取得し、プロジェクトに配置してください。たったこれだけです。4つのファイルで、プロンプトだけで実行するよりもエージェントセッションが大幅に安定します。
...
*各レクチャーの全文は[ドキュメントウェブサイト](https://letslego.github.io/harness-engineering)で読めます。*
