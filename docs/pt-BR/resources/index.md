...
- [`templates/`](./templates/): modelos para copiar em um repositório real
- [`reference/`](./reference/): notas de método, fluxo de inicialização e mapas de modos de falha
- [`openai-advanced/`](./openai-advanced/): esqueleto de repositório avançado, documentos de sistema de registro e modelos de governança focados em agentes
...
Quando o repositório crescer para um sistema de longa duração com múltiplos domínios, planos ativos, pontuação de qualidade e políticas de confiabilidade, mude para o pacote [`openai-advanced/`](./openai-advanced/) em vez de forçar demais o pacote mínimo.
