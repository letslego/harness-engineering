...
- [Aula 11: Por Que Observabilidade Pertence ao Harness](../../docs/pt-BR/lectures/lecture-11-why-observability-belongs-inside-the-harness/)
- [Aula 12: Por Que Toda Sessão Deve Deixar um Estado Limpo](../../docs/pt-BR/lectures/lecture-12-why-every-session-must-leave-a-clean-state/)