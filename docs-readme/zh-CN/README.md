...
完整的课程材料，请访问**[文档网站](https://letslego.github.io/harness-engineering)**。
...
从[资源库](https://letslego.github.io/harness-engineering/en/resources)获取入门模板，放入你的项目。就这样。四个文件，你的代理会话就会比仅靠提示词稳定得多。
...
*在[文档网站](https://letslego.github.io/harness-engineering)上阅读每讲完整文本。*
