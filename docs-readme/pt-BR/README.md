...
Para os materiais completos do curso, visite o **[Site de Documentação](https://letslego.github.io/harness-engineering)**.
...
Pegue os modelos iniciais da [Biblioteca de Recursos](https://letslego.github.io/harness-engineering/pt-BR/resources) e coloque-os em seu projeto. É isso. Quatro arquivos, e suas sessões de agente já serão significativamente mais estáveis do que rodando apenas com prompts.
...
*Leia o texto completo de cada aula no [Site de Documentação](https://letslego.github.io/harness-engineering).*
...
- [English](https://letslego.github.io/harness-engineering/en/resources) — modelos, checklists e referências de métodos
...
[![Modern LLM Notebook](https://img.shields.io/badge/MODERN_LLM_NOTEBOOK-0052cc?style=for-the-badge)](https://letslego.github.io/harness-engineering)
