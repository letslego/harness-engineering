...
完整的課程資料，請造訪**[文件網站](https://letslego.github.io/harness-engineering)**。
...
從[資源庫](https://letslego.github.io/harness-engineering/en/resources)取得入門模板，放入你的專案。就是這樣。四個檔案，你的代理工作階段就會比僅靠提示穩定得多。
...
*在[文件網站](https://letslego.github.io/harness-engineering)上閱讀每堂講座的完整內容。*
