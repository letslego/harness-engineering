...
Gói bắt đầu trong [`repo-template/`](./repo-template/) phản ánh cấu trúc dưới đây:
...
2. Sao chép các tệp trong [`repo-template/`](./repo-template/) vào kho lưu trữ của bạn khi bạn cần cấu trúc mạnh hơn.
...
Thư mục [`sops/`](./sops/) biến các sơ đồ của bài viết thành các quy trình vận hành từng bước:
