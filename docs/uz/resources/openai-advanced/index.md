...
[`repo-template/`](./repo-template/) ostidagi boshlangʻich toʻplam quyidagi tuzilmani aynan takrorlaydi:
...
2. Kuchliroq tuzilma kerak boʻlganda [`repo-template/`](./repo-template/) ichidagi fayllarni oʻz repozitoriyingizga koʻchiring.
...
[`sops/`](./sops/) jildi maqoladagi diagrammalarni bosqichma-bosqich ishlash protseduralariga aylantiradi:
