...
- [`templates/`](./templates/) : modèles à copier dans un vrai dépôt
- [`reference/`](./reference/) : notes de méthode, flux de démarrage et cartes des modes de défaillance
- [`openai-advanced/`](./openai-advanced/) : squelette de dépôt avancé, documents system-of-record et modèles de gouvernance agent-first
...
Lorsque le dépôt devient un système durable avec plusieurs domaines, des plans actifs, une notation qualité et des politiques de fiabilité, passez au pack [`openai-advanced/`](./openai-advanced/) au lieu d'étirer trop loin le pack minimal.
