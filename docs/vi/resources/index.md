...
- [`templates/`](./templates/): các mẫu để sao chép vào một kho lưu trữ thực tế
- [`reference/`](./reference/): ghi chú phương pháp, luồng khởi động và sơ đồ chế độ lỗi
- [`openai-advanced/`](./openai-advanced/): khung kho lưu trữ nâng cao, tài liệu nguồn sự thật, và các mẫu quản trị ưu tiên agent
...
[`openai-advanced/`](./openai-advanced/) thay vì cố mở rộng gói tối giản quá xa.
