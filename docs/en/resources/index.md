...
- [`templates/`](./templates/): templates to copy into a real repo
- [`reference/`](./reference/): method notes, startup flow, and failure-mode maps
- [`openai-advanced/`](./openai-advanced/): advanced repo skeleton,
...
[`openai-advanced/`](./openai-advanced/) pack instead of stretching the
