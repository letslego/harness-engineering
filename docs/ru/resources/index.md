...
- [`templates/`](./templates/): шаблоны для копирования в реальный репозиторий
- [`reference/`](./reference/): заметки по методу, флоу старта и карты режимов отказа
- [`openai-advanced/`](./openai-advanced/): продвинутый каркас репозитория, документы system-of-record и шаблоны agent-first управления
...
Когда репозиторий вырастает в долгоживущую систему с несколькими доменами, активными планами, оценкой качества и политиками надёжности, переходите на пак [`openai-advanced/`](./openai-advanced/), а не растягивайте минимальный пак сверх меры.
