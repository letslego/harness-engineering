...
- [`templates/`](./templates/): plantillas para copiar en un repositorio real
- [`reference/`](./reference/): notas de método, flujo de arranque y mapas de modos de fallo
- [`openai-advanced/`](./openai-advanced/): esqueleto avanzado de repositorio, documentos system-of-record y plantillas de gobernanza agent-first
...
Cuando el repositorio crezca hasta convertirse en un sistema de larga duración con varios dominios, planes activos, puntuación de calidad y políticas de fiabilidad, pasa al paquete [`openai-advanced/`](./openai-advanced/) en lugar de estirar demasiado el paquete mínimo.
