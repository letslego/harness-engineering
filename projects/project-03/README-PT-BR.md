...
- [Aula 05: Por Que Tarefas de Longa Duração Perdem Continuidade](../../docs/pt-BR/lectures/lecture-05-why-long-running-tasks-lose-continuity/)
- [Aula 06: Por Que a Inicialização Precisa Ter Sua Própria Fase](../../docs/pt-BR/lectures/lecture-06-why-initialization-needs-its-own-phase/)